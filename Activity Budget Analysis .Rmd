...
setwd("~/Desktop/chapter 3 ibis data chapter/2019 Activity Budget Data Analysis")

#Read in data----
behav<-read_excel("Summer 2019 Field Data.xlsx", 
...
focTable_all<- read_excel("Summer 2019 Field Data.xlsx", 
                          sheet = "focalsTable") #read in 'focTable' to get the end focal times 
groupsize<-read_excel("Summer 2019 Field Data.xlsx", 
                      sheet = "Flock Composition")
people<- read_excel("Summer 2019 Field Data.xlsx", 
                    sheet = "People Feeding")

flockcomp<- read_excel("Summer 2019 Field Data.xlsx", 
                    sheet = "Flock Composition")
...
proximity<- read_excel("Summer 2019 Field Data.xlsx", 
...
isotope <- read_excel("murryetal2018philtrans_isotope.xlsx")
