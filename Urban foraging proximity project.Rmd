...
1. Video data: data were collected using ~5 minute overhead videos of ibis being fed bread at urban parks in South Florida during summer 2019. ~7 focal birds were 'followed' in each video and the # of conspecifics within a 1m radius of the focal bird was recroded at 5 equally spaced time points during the observation. If a 1m radius was not in view (e.g., the bird was closer to the end of the video frame), no data were collected. 
...
vid0<- read_excel("Ibis Behavior.xlsx",sheet = "1m_density")
vid <- read_excel("Ibis Behavior.xlsx",sheet = "1m_density")
...
```{r message=FALSE, warning=FALSE}
FFprox_1m <- read_excel("Summer 2019 Field Data copy.xlsx", 
                                          sheet = "proximity")
...
```{r include=FALSE}
scan_FS<-read_excel("Summer 2019 Field Data copy.xlsx", 
...
vid_FS <- read_excel("foraging video data copy.xlsx", 
