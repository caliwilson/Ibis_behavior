...
```{r message=FALSE, warning=FALSE}
FFprox_1m <- read_excel("data/Summer 2019 Field Data copy.xlsx", 
                                          sheet = "proximity")
...
```{r include=FALSE}
scan_FS<-read_excel("data/Summer 2019 Field Data copy.xlsx", 
...
vid_FS <- read_excel("data/foraging video data copy.xlsx", 
